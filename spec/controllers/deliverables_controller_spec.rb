...
describe DeliverablesController do
  ...
  describe "GET index" do
    it "assigns all deliverables as @deliverables" do
      Deliverable.stub(:find).with(:all).and_return([mock_deliverables])
      get :index
  ...
  describe "GET new" do
    it "assigns a new deliverables as @deliverables" do
      Deliverable.stub(:new).and_return(mock_deliverables)
      get :new
      assigns[:deliverables].should equal(mock_deliverables)
    end
  end
  ...
  describe "POST create" do
    ...
    describe "with valid params" do
      it "assigns a newly created deliverables as @deliverables" do
        Deliverable.stub(:new).with({'these' => 'params'}).and_return(mock_deliverables(:save => true))
        post :create, :deliverables => {:these => 'params'}
        assigns[:deliverables].should equal(mock_deliverables)
      end

      it "redirects to the created deliverables" do
        Deliverable.stub(:new).and_return(mock_deliverables(:save => true))
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved deliverables as @deliverables" do
        Deliverable.stub(:new).with({'these' => 'params'}).and_return(mock_deliverables(:save => false))
        post :create, :deliverables => {:these => 'params'}
        assigns[:deliverables].should equal(mock_deliverables)
      end

      it "re-renders the 'new' template" do
        Deliverable.stub(:new).and_return(mock_deliverables(:save => false))
        post :create, :deliverables => {}
  ...
  describe "PUT update" do
    ...
    describe "with valid params" do
      it "updates the requested deliverables" do
        Deliverable.should_receive(:find).with("37").and_return(mock_deliverables)
        mock_deliverables.should_receive(:update_attributes).with({'these' => 'params'})
        put :update, :id => "37", :deliverables => {:these => 'params'}
      end

      it "assigns the requested deliverables as @deliverables" do
        Deliverable.stub(:find).and_return(mock_deliverables(:update_attributes => true))
        put :update, :id => "1"
        assigns[:deliverables].should equal(mock_deliverables)
      end
    ...
    describe "with invalid params" do
      ...
      it "assigns the deliverables as @deliverables" do
        Deliverable.stub(:find).and_return(mock_deliverables(:update_attributes => false))
        put :update, :id => "1"
        assigns[:deliverables].should equal(mock_deliverables)
      end
  ...
  describe "DELETE destroy" do
    ...
    it "redirects to the deliverables list" do
      Deliverable.stub(:find).and_return(mock_deliverables(:destroy => true))
      delete :destroy, :id => "1"
